...
public class Chronometer01 extends Chronometer {
    public Chronometer01(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // TODO 自动生成的构造函数存根
    ...
    public Chronometer01(Context context)
    {
        super(context);
